...
import ModbusRequestPanel from '../components/modbus/ModbusRequestPanel.vue'
  ...
  <div class="flex h-full min-h-0 w-full flex-col overflow-hidden bg-slate-50 text-sm text-slate-800 transition-colors dark:bg-slate-900 dark:text-slate-200">
    ...
    <div class="grid flex-1 min-h-0 grid-cols-[320px_minmax(0,1fr)_340px] overflow-hidden">
      <ModbusRequestPanel
        ...
        :is-sending-modbus-request="isSendingModbusRequest"
        :is-polling-modbus="isPollingModbus"
        :polling-progress-label="pollingProgressLabel"
        ...
        @send-built-frame="handleSendBuiltFrame"
        @use-build-result-as-response-input="useBuildResultAsResponseInput"
        @start-modbus-polling="startModbusPolling"
        @stop-modbus-polling="stopModbusPolling"
